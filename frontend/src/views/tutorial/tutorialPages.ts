        ...
        sections: [
          ...
          },
          {
            ...
            paragraphs: [
              ...
              "历史 FAST 事实只能通过具备 verified coverage 的远端修复计划更正，并与同一采样点的账号和用户事实组原子应用。",
            ],
          },
        ],
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        title: "数据维护与排错",
        summary:
          "用不可变计划审计、验证、应用和回滚历史事实，并安全迁移数据库。",
        icon: "wrench-screwdriver",
        sections: [
          {
            title: "本地审计与远端验证修复",
            paragraphs: [
              "“本地审计并重放”会检查所有观测与非观测采样点的窗口、用户集合、账号残差和历史 FAST 明细；它从计划创建到应用都不会连接 Sub2API，只重算可派生结果。",
              "“远端验证修复”会分块读取候选日志并保存逐维 coverage。只有账号成本、用户成本和 FAST 事实分别获得独立 verified 证据时，才会生成可应用的 typed patch；分页完整、exact_total、非空响应和查询天数都不等于历史完整。",
              "确认应用时只提交 plan id 与 digest，系统不会重新联网。成功后可按维护栈逆序恢复本次 touched source before-image；cutoff 后的新采样保留，数据库字节级恢复仍依赖完整备份。",
            ],
          },
          {
            title: "数据库迁移",

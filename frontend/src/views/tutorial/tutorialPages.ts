        ...
        sections: [
          ...
          },
          {
            ...
            steps: [
              ...
              "如需让车友查看数据，创建普通系统用户，再分别配置可访问页面和具体可见参与者。",
      ...
      },
      {
        ...
        sections: [
          ...
          },
          {
            title: "创建普通系统用户",
            paragraphs: [
              "需要让车友自行查看时，由管理员先在“系统用户”页面创建登录账号，再点击该用户右侧的“编辑权限”。",
              "页面权限决定普通用户能进入哪些功能；参与者权限会统一过滤额度总览、参与者、观测记录、额度统计和通知记录中的具体参与者。普通用户获得的页面均为只读，不能触发测算、调额、编辑、封禁或维护操作。",
            ],
          },
        ],
